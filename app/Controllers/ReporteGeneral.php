...
class ReporteGeneral extends BaseController
{
    ...
    public function lapaz()
    {
        ...
        //$formularios_respuesta = $reporte->getFormulariosResp();
        $idciudad = 1; //La Paz
        $formularios_respuesta = $reporte->getFormulariosRespPorCiudad($idciudad);
        //Items
        $items = $reporte->getAllItems();
        ...
        //Escribir el documento
        $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, 'Xlsx');
        $documento = ROOTPATH.'writable/reporte-general-lapaz.xlsx';
        $writer->save($documento);
    ...
    public function elalto()
    {
        ...
        //Escribir el documento
        $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, 'Xlsx');
        $documento = ROOTPATH.'writable/reporte-general-elalto.xlsx';
        $writer->save($documento);
    ...
    public function cochabamba()
    {
        ...
        //Escribir el documento
        $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, 'Xlsx');
        $documento = ROOTPATH.'writable/reporte-general-cochabamba.xlsx';
        $writer->save($documento);
    ...
    public function santacruz()
    {
        ...
        //Escribir el documento
        $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, 'Xlsx');
        $documento = ROOTPATH.'writable/reporte-general-santacruz.xlsx';
        $writer->save($documento);
